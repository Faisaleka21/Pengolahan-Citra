...
Image1 = imread('Noise-Quanti.tif');
Image2 = imread('Noise-Poisson.tif');
Image3 = imread('Noise-Speckle.tif');
Image4 = imread('Noise-Salt-Paper.tif');
Image5 = imread('Noise-Gaussian.tif');
...
for i = 1:5
    ...
    figure(i,'name','Filter Ketetanggaan','numbertitle','off'); % Figure 1–5
...
for i = 1:5
    ...
    figure(i + 5,'name','Filter Perataan','numbertitle','off'); % Figure 6–10
...
for i = 1:5
    ...
    figure(i + 10,'name','Filter Median','numbertitle','off'); % Figure 11–15
